...
// app/javascript/modules/avatar_preview.js
...
// app/javascript/modules/comment_edit.js
document.addEventListener("turbo:load", () => {
  ...
  document.addEventListener("click", (e) => {
    if (form.classList.contains("is-shown-block") && !form.contains(e.target) && !editBtn.contains(e.target)) {
      closeForm();
    }
  });
...
// app/javascript/modules/devise_password.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/fadein.js
var setupObserver = () => {
...
// app/javascript/modules/favorite_author.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/flash.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/modal_account_delete.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/modal_author_delete.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/modal_book_delete.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/modal_register.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/published_date.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/reading_status_modal.js
document.addEventListener("turbo:load", () => {
...
// app/javascript/modules/search_box.js
...
function attachSearchValidation() {
  const forms2 = document.querySelectorAll(".c-search__form");
  forms2.forEach((form) => {
    ...
    if (input && warning) {
      let isSpView2 = function() {
        return window.innerWidth <= 767;
      };
      var isSpView = isSpView2;
      if (mode === "header") {
        form.dataset.isOpen = "false";
      }
      form.addEventListener("submit", (e) => {
        const query = input.value.trim();
        if (mode === "header" && isSpView2()) {
